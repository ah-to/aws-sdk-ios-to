Pod::Spec.new do |s|
   ...
   s.platform     = :ios, '12.0'
   s.source       = { :git => 'https://github.com/ah-to/aws-sdk-ios-to.git',
                      :tag => s.version}
   s.requires_arc = true
   ...
   s.source_files = 'AWSAuthSDK/Sources/AWSMobileClient/*.{h,m}', 'AWSCognitoAuth/**/*.{h,m,c}', 'AWSAuthSDK/Sources/AWSMobileClient/Internal/*.{h,m}', 'AWSAuthSDK/Sources/AWSMobileClient/**/*.swift'
