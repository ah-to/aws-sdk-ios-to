...
- (AWSTask<AWSCognitoIdentityUserSession*>*) getSessionInternal: (AWSTask<AWSCognitoIdentityProviderRespondToAuthChallengeResponse *>*) task{
    return [task continueWithSuccessBlock:^id _Nullable(AWSTask<AWSCognitoIdentityProviderRespondToAuthChallengeResponse *> * _Nonnull task) {
        ...
        if(AWSCognitoIdentityProviderChallengeNameTypeSmsMfa == nextChallenge || AWSCognitoIdentityProviderChallengeNameTypeSoftwareTokenMfa == nextChallenge || AWSCognitoIdentityProviderChallengeNameTypeUnknown == nextChallenge
           || AWSCognitoIdentityProviderChallengeNameTypeEmailOtp == nextChallenge){
...
-(AWSTask<AWSCognitoIdentityUserSession *>*) mfaAuthInternal: (NSString *) deliveryMedium
    ...
    if(AWSCognitoIdentityProviderChallengeNameTypeEmailOtp == challengeName){
        responseKey = @"EMAIL_OTP_CODE";
    }
